      ...
      return {
        ...
        patients: {
          ...
          allIds: _.union(
            ...
            action.payload.patients.allIds
          )
        },
        doctors: {
          ...
          allIds: _.union(
            [],
            state.doctors.allIds,
            action.payload.doctors.allIds
          )
        },
        pendingRequests: {
          byId: _.merge(
            {},
            state.pendingRequests.byId,
            action.payload.pendingRequests.byId
          ),
          allIds: _.union(
            [],
            state.pendingRequests.allIds,
            action.payload.pendingRequests.allIds
          )
        },
        prescriptions: {
          byId: _.merge(
            {},
            state.prescriptions.byId,
            action.payload.prescriptions.byId
          ),
          allIds: _.union(
            [],
            state.prescriptions.allIds,
            action.payload.prescriptions.allIds
          )
        },
        isFetchingUser: false,
        isLoggedIn: true
